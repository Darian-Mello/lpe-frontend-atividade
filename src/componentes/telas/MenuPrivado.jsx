        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                <div className="container-fluid">
                    <NavLink className="navbar-brand" aria-current="page" exact="true" to="/privado">Atividade</NavLink>
                            ...
                            {usuario &&
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <li><NavLink className="dropdown-item" exact="true" to="atividades">Atividades</NavLink></li>
                                        <li><NavLink className="dropdown-item" exact="true" to="acoes">Acões</NavLink></li>
                                    </ul>
                                </li>
                            }
                            <li className="nav-item dropdown">
